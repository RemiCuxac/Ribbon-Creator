...
# TODO: maybe change the naming of controllers and joints ? Because almost all components are named like {RibbonName}...
#  but controllers, joints, control joints and locators are named like ctrl_{RibbonName}_...
