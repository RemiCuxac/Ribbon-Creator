...
def onMayaDroppedPythonFile(*args, **kwargs):
    try:
        ...
        ribbonFolder = os.path.join(scriptFolder, "RibbonGeneratorTool")
        ...
        nameExport = 'RG'
        tooltipRibbon = 'Ribbon Generator Tool'
        commandRibbon = "from RibbonGeneratorTool import RibbonGenerator as rg\n"\
        ...
        logoPath = os.path.join(ribbonFolder, "RibbonGenerator.png")
