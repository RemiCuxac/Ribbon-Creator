...
try:
    ...
    filePath = ("/Users/remicuxac/Desktop/CODE/Python/Project Folders/PycharmProject1/"
                "Maya/RibbonGeneratorTool/RibbonGenerator.py")

try:
    import RibbonGeneratorTool.RibbonGeneratorOperations as RibbonGenOp
...
uiPath = os.path.join(os.path.dirname(filePath), "RibbonGenerator.ui")
ToolName = "Ribbon Generator Tool"
